...
![Profile Image](https://github.com/PAVANKUMARELETI/Personal/blob/64e702071d93851cb9fd9c8c8964e247f08a6817/Pavan%20Kumar%20Eleti%20(2).png)

<h1 style="text-align: center;">Hi... This is Mr Eleti 👋</h1>
...
I'm a Masters student in DataScience from Indian Institute of Information Technology Lucknow, with expertising in data analysis and reporting, query optimization, data modelling and data visualizations.
...
| Project Link | Tools Used | Area of Analysis | Project Description |
|--------------|------------|------------------|---------------------|
| [![Telangana SEG](https://img.shields.io/badge/Telangana%20SEG-6C63FF?style=for-the-badge&logo=googlebigquery&logoColor=white)](#)(click me) | Microsoft Excel, Bigquery, Tableau | Data cleaning, Data analysis, Data Exploration, Data Visualization, Dashboard, Story, Video presentation | This individual interactive dashboard leverages the comprehensive & quantitative analysis of the state in India, Telangana to achieve sustainable Economic Growth. Click on this Button for the Overview. |
| [![Meta Stock Price](https://img.shields.io/badge/Meta%20Stock%20Price-F94144?style=for-the-badge&logo=tableau&logoColor=white)](#)(click me) | Tableau, Microsoft Excel | Data cleaning, Data analysis, Data Exploration, Data Visualization, Dashboard | This vizz contains the analysis of the stock prices of company META for the past five years and prediction analysis for the next one year through forecasting and using Model-Quantile & percentile concept of linear regression in Tableau. |
| [![Sara Boutique](https://img.shields.io/badge/Sara%20Boutique-FFAD60?style=for-the-badge&logo=powerbi&logoColor=white)](#)(click me) | PowerBi, Microsoft Excel | Data cleaning, Data analysis, Data Exploration, Data Visualization, Dashboard | This vizz contains financial report, budget analysis for Sara Fashion Boutique, and offered suggestion and key strategy recommendations for the growth. |
| [![Netflix Analysis](https://img.shields.io/badge/Netflix%20Analysis-2EC4B6?style=for-the-badge&logo=tableau&logoColor=white)](#)(click me) | Tableau, Microsoft Excel | Data cleaning, Data analysis, Data Exploration, Data Visualization, Dashboard, Story Creation | This vizz contains the content & growth analysis of the company NETFLIX and offered suggestion and key strategy recommendations for the growth. |

# Microsoft Excel

| Project Link | Tools Used | Area of Analysis | Project Description |
|--------------|------------|------------------|---------------------|
| [![Fashio Shoppy](https://img.shields.io/badge/Fashio%20Shoppy-FF5A5F?style=for-the-badge&logo=microsoftexcel&logoColor=white)](#)(click me) | Microsoft Excel | Data cleaning, Data analysis, Data Exploration, Data Visualization, Dashboard | This vizz serves as the sales analysis of Big Fashion Store named Fashio Shoppy who has branches all over Australia. (Best viewed in Microsoft Excel fullscreen [Any Version]) |
